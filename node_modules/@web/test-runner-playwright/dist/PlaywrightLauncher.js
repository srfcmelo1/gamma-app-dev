...
class PlaywrightLauncher {
    ...
    async createNewPage(browser, context) {
        ...
        return new PlaywrightLauncherPage_1.PlaywrightLauncherPage(this.config, this.testFiles, playwrightPage);
    }
    ...
    async getOrStartBrowser() {
        ...
        if (!this.browser || !this.browserContext || !((_a = this.browser) === null || _a === void 0 ? void 0 : _a.isConnected())) {
